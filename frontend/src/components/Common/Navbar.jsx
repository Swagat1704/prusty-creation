  ...
  return (
    <>
      <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
        {/* logo */}
         <div>
            <Link to={"/"} className='text-2xl font-medium text-[black]'>GRAFIX HUB
            </Link>
         </div>
         ...
         <div className="flex items-center space-x-4">
          ...
          <button onClick={toggleCartDrawer} className='relative hover:text-black'>
            ...
            <span className='absolute -top-1 bg-vibrantOrange text-[white] text-xs rounded-full px-2 py-0.5'>4</span>
          </button>
          {/* Search */}
